...
from sphinx_llms_txt import (
    ...
    FileWriter,
    LLMSFullManager,
    _extract_first_paragraph_from_rst,
    _get_root_page_first_paragraph,
    setup,
)
...
def test_extract_first_paragraph_from_rst():
    """Test extracting the first paragraph from RST content."""
...
This is the second paragraph.
    ...
    app = MockApp()
    result = _extract_first_paragraph_from_rst(app, rst_content)
    assert result == "This is the first paragraph with some text."


def test_extract_first_paragraph_from_rst_with_directives():
    """Test extracting first paragraph while skipping directives."""
    rst_content = """
Title
=====
...
Another paragraph.
    ...
    app = MockApp()
    result = _extract_first_paragraph_from_rst(app, rst_content)
    assert result == "This is the first actual paragraph."


def test_extract_first_paragraph_from_rst_empty():
    """Test extracting first paragraph from RST with no paragraphs."""
    rst_content = """
Title
=====
...
def test_get_root_page_first_paragraph(tmp_path):
    """Test getting the first paragraph from the root page."""
    # Create a mock source file
    source_content = """
Welcome to My Project
=====================

This is the introduction paragraph explaining what this project does.
...
More details follow here.
    ...
    app = MockApp()
    result = _get_root_page_first_paragraph(app)
    assert (
        result
        == "This is the introduction paragraph explaining what this project does."
    )
...
def test_get_root_page_first_paragraph_no_file(tmp_path):
    """Test getting first paragraph when root page file doesn't exist."""

    # Mock Sphinx app with non-existent file
    class MockApp:
        class Config:
