...
class FileWriter:
    ...
    def write_verbose_info_to_file(self, page_order: List[str], page_titles: Dict[str, str], total_line_count: int = 0):
...
class LLMSFullManager:
    ...
    def combine_sources(self, outdir: str, srcdir: str):
        ...
        success = self.writer.write_combined_file(content_parts, output_path, total_line_count)
